...
console.log(items.some(x => x.text == "Ballena")); //TODO. Resultado esperado: false
...
console.log(items.some(x => x.Tags.includes("ES6"))); //TODO. Resultado esperado: true (la última!)
